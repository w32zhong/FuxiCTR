...
class BaseModel(nn.Module):
    ...
    def evaluate_generator(self, data_generator, csv_dir=None, expid=None):
        ...
        with torch.no_grad():
            ...
            val_logs = self.evaluate_metrics(y_true, y_pred, self._validation_metrics, csv_dir=csv_dir, expid=expid)
            return val_logs
